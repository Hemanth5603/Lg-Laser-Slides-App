                      ...
                      Container(
                        ...
                        child: const Column(
                          children: [
                            ...
                            Text(
                              "Now that we are connected, if we double tap on any buttom we get to see a popup which can be used to edit the button. In the popup we can edit all the necessary fields accordingly.",
                              style: TextStyle(
                                  fontFamily: 'sen',
                                  fontSize: 17,
                                  color: Colors.white),
                      ...
                      Container(
                        ...
                        child: const Column(
                          children: [
                            ...
                            Text(
                              "LaserSlides is based on QuickOSC https://github.com/ahmetkizilay/QuickOSC-as \n\nModified by Albert Merino and Artur Cullerés LiquidGalaxyLab interns",
                              style: TextStyle(
                                  fontFamily: 'sen',
                                  fontSize: 17,
                                  fontWeight: FontWeight.bold,
